...
int check3lowconnect(int height, int width, int pixels[height][width], int lastconnectpos[72], int currentconnectpos[72], int checkline, int a);
int check3upconnect(int height, int width, int pixels[height][width], int lastconnectpos[72], int currentconnectpos[72], int checkline, int a);
int check3upperend(int height, int width, int pixels[height][width], int checkline, int a);
int check3lowerend(int height, int width, int pixels[height][width], int checkline, int a);
...
int check3(int height, int width, int pixels[height][width]){
    ...
    while(j<width){
        ...
        if((j!=0 && checkstart==3 && start==0 && connected==1 && check3upconnect(height, width, pixels, lastconnectpos, currentconnectpos, j, 1)==0) || (start==0 && checkstart<3 && connected==1)){
            start=1;
            //printf("1");
            
            if((check3upperend(height, width, pixels, j-1, 1)==1) && connected==1){
                confirm1=1;
                connected=0;
            }
            else if(k<lastk){
    ...
    while(j<width){
        ...
        if((j!=0 && checkstart==3 && start==0 && connected==1 && check3lowconnect(height, width, pixels, lastconnectpos, currentconnectpos, j, 1)==0) || (start==0 && checkstart<3 && connected==1)){
            start=1;
            //printf("9");
            if((check3lowerend(height, width, pixels, j-1, 1)==1) && connected==1){
                confirm2=1;
                connected=0;
            }
            else if(k>lastk){
